...
module "apps_3a_to_124" {
  source            = "./modules/f5xc/apps"
  providers         = { volterra = volterra.default }
  namespace         = volterra_namespace.ns.name
  name              = "mw-apps3a-to-124"
  origin_port       = 8080
  origin_servers    = {
    "mw-azure-site-1a": { ip = element(module.azure_workload_1a[*].output.private_ip,0) },
    "mw-azure-site-1b": { ip = element(module.azure_workload_1b[*].output.private_ip,0) },
    "mw-azure-site-2a": { ip = element(module.azure_workload_1a[*].output.private_ip,0) },
    "mw-azure-site-2b": { ip = element(module.azure_workload_1b[*].output.private_ip,0) },
    "mw-aws-site-4a"  : { ip = element(module.aws_workload_4a[*].private_ip,0) },
    "mw-aws-site-4b"  : { ip = element(module.aws_workload_4b[*].private_ip,0) },
    "mw-aws-site-4a"  : { ip = element(module.aws_workload_4a[*].private_ip,0) },
    "mw-aws-site-4b"  : { ip = element(module.aws_workload_4b[*].private_ip,0) }
  ...
  domains           = ["workload.example"]
  advertise_site    = "mw-aws-site-3a"
  advertise_vip     = "100.64.15.254"
  advertise_port    = 80
}

module "apps_3b_to_124" {
  source            = "./modules/f5xc/apps"
  providers         = { volterra = volterra.default }
  namespace         = volterra_namespace.ns.name
  name              = "mw-apps3b-to-124"
  origin_port       = 8080
  origin_servers    = {
    "mw-azure-site-1a": { ip = element(module.azure_workload_1a[*].output.private_ip,0) },
    "mw-azure-site-1b": { ip = element(module.azure_workload_1b[*].output.private_ip,0) },
